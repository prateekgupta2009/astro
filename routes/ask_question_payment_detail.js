...
const OnlinePuja_payment_detail = require('../models/askQuestionn_payment_detail');
const database = require('../config/database')

router.post('/askquestion_create_paymment_detail', async (req, res, next) => {
    try {
        const data={
        ...
        OnlinePuja_payment_detail.create(
            data
              ...
              res.send({
                msg: 'create askquestion payment detail',
                result:result
              })
          })
          .catch(err=>{
